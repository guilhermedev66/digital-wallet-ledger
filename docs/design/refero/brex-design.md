...
Refero Styles page title: "Brex design system | Refero Styles"
Underlying subject: https://brex.com (Refero's own "isBasedOn" metadata)
Retrieved: 2026-09-24, via direct HTTP fetch of the page's server-rendered
HTML and extraction of the literal `DESIGN.md` `<code>` block Refero embeds
on the page (the exact text behind that page's own "Copy .md" button) —
not an AI-generated summary of the page. HTML entities were unescaped;
no other transformation was applied. Verbatim from this point down.
-->
